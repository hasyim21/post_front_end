...
class QrisResponseModel {
  ...
  @override
  String toString() {
    return 'QrisResponseModel(statusCode: $statusCode, statusMessage: $statusMessage, transactionId: $transactionId, orderId: $orderId, merchantId: $merchantId, grossAmount: $grossAmount, currency: $currency, paymentType: $paymentType, transactionTime: $transactionTime, transactionStatus: $transactionStatus, fraudStatus: $fraudStatus, actions: $actions, expiryTime: $expiryTime)';
  }
}
...
class Action {
  ...
  @override
  String toString() => 'Action(name: $name, method: $method, url: $url)';
}
